...
```{r Errors}
n <- 3
end_points <- cumsum(rep(n, 4))[-1]
graph <- new_barry_graph(n*4,
                         c(t_source,a_source,b_source,c_source),
                         c(t_target,a_target,b_source,c_source))
ans <- count_recip_errors(graph,n = 3, end_points)
