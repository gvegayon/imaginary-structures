...
```{r descriptive stats}
table <- data.frame(Network = c('HM AFN','HM PFN', 'HM AANs','HM PANs'),
                    People = c(network.size(fr.true),paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])),network.size)),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])),network.size)),2)),network.size(ad.true),paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])),network.size)),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])),network.size)),2))),
                    Edges = c(network.edgecount(fr.true),paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])),network.edgecount)),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])),network.edgecount)),2)),network.edgecount(ad.true),paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])),network.edgecount)),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])),network.edgecount)),2))),
                    Density = c(round(network.density(fr.true),2),paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])),network.density)),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])),network.density)),2)),round(network.density(ad.true),2),paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])),network.density)),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])),network.density)),2))),
                    Mutual = c(dyad.census(fr.true)[[1,1]],paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])), function(x) dyad.census(x)[[1,1]])),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])), function(x) dyad.census(x)[[1,1]])),2)),dyad.census(ad.true)[[1,1]],paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])), function(x) dyad.census(x)[[1,1]])),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])), function(x) dyad.census(x)[[1,1]])),2))),
                    Asymmetric = c(dyad.census(fr.true)[[1,2]],paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])), function(x) dyad.census(x)[[1,2]])),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])), function(x) dyad.census(x)[[1,2]])),2)),dyad.census(ad.true)[[1,2]],paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])), function(x) dyad.census(x)[[1,2]])),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])), function(x) dyad.census(x)[[1,2]])),2))),
                    Null = c(dyad.census(fr.true)[[1,3]],paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])), function(x) dyad.census(x)[[1,3]])),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_fr[x,,])), function(x) dyad.census(x)[[1,3]])),2)),dyad.census(ad.true)[[1,3]],paste(round(mean(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])), function(x) dyad.census(x)[[1,3]])),2),'\u00B1',round(sd(sapply(lapply(1:mat_size,function(x) as.network(css_ad[x,,])), function(x) dyad.census(x)[[1,3]])),2))))
...
ind_table <- function(id_len = c(0:20),fr.ans,fr.ans0){
  fr.table <- cbind(t(sapply(id_len,ind_test,1,fr.ans,fr.ans0)),
  ...
  colnames(fr.table) <- rep(c('Z' , 'p','obs','M','SD'),10)
  return(fr.table)
}
